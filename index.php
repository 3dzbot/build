        ...
        <div class="about">
            ...
            <div class="company_word">
                ...
                <div class="company_word-content">
                    ...
                    <p class="word_content-text"><?php the_field('video-description', 89); ?></p>
                    <a href="<?php echo get_permalink(6); ?>" class="word_content-btn w-button"><?php the_field('video-button-text', 89); ?></a>
                </div>
            </div>
        </div>
    </div>
								...
								while ( $query->have_posts() ) {
                                    ...
                                    <div class="reviews_slider-1 w-slide">
                                        ...
                                        <div class="reviews_person">
                                            <img src=" /images/5cdbbf15b102f93b0a08354d_quote-left-solid.svg"                                    width="36" alt="image" class="reviews_person-icon">
