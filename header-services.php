...
<body   <?php body_class('body_services'); ?>>
<header class="sec_1">
    <div class="header">
        ...
        <?php wp_nav_menu([
            ...
            <div class="block_content">
                ...
                <a href="files/download.txt" class="link_btn-file w-inline-block" download>
                    <div class="btn_file-icon"><i class="fas fa-file-pdf"></i></div>
                    <div class="btn_file-text">download brochure</div>
                </a>
                <div class="block_content-text"><?php the_content(); ?></div>
            </div>
        </div>
        <div class="header_bg" style="background-image: url('<?php echo get_the_post_thumbnail_url('', 'post-bg'); ?>');"></div>
    </div>
</header>
<!-- /header -->